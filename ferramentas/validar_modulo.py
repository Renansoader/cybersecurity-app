...
resposta, distrator que é o gabarito de outra questão e o molde "Pergunte…" na
dica. Elas saíram de defeitos reais achados à mão na revisão do nível 3; a
seção correspondente do README explica o cálculo e os limites.

Uma quinta regra — unicidade estrutural, a correta ser a única entre as
quatro com dígito ou sem negação — existiu de 31/08/2026 a 01/09/2026 e foi
removida: medida contra o corpus inteiro (não contra o conjunto que ela
mesma definia), a taxa de acerto ficou em 27% e 17,8%, contra 25% de acaso
— não distinguia nada. Ver `ferramentas/relatorio_regra7_chutador.md` e o
padrão aprendido no PROGRESS.md §7.
